...
import {GetStartedButton as GetStartedButton} from "../components/misc/Buttons";
...
const Button = styled(GetStartedButton).attrs({as: "a"})`
...
const Actions = styled.div`
  ...
  ${Button} {
    ${tw`w-full text-base sm:absolute right-0 top-0 bottom-0 bg-primary-500 text-gray-100 font-bold mr-2 my-4 sm:my-2 rounded-full py-4 flex items-center justify-center sm:w-40 sm:leading-none focus:outline-none hover:bg-primary-900 transition duration-300`}
  }
`;
